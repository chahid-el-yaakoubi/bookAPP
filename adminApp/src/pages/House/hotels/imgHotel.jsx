...
const ImgHotel = ({ hotelId }) => {
    ...
    const {data: hotel} = useFetch(`/api/hotels/find/${hotelId}`);
    ...
    const handleDeleteImage = async (imageUrl) => {
        ...
        try {
            ...
            const response = await axios.delete(`/api/hotels/${hotelId}/photos`, {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/api/hotels/${hotelId}/upload`, formData, {
                headers: {
