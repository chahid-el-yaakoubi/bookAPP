...
const HouseRentals = () => {
    ...
    useEffect(() => {
        if (fetchedData) {
            const transformedData = fetchedData.map((item, i) => ({
                ...
                whatsapp: item.contact?.whatsapp || "N/A",
                price: item.rental?.price || "N/A",
                bedrooms: item.specifications?.bedrooms || "N/A",
                bathrooms: item.specifications?.bathrooms || "N/A",
                size: item.specifications?.size || "N/A",
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 150,
            renderCell: (params) => (
                `${params.row.bedrooms} bed, ${params.row.bathrooms} bath, ${params.row.size}m²`
            ),
        },
        {
            field: "contact",
