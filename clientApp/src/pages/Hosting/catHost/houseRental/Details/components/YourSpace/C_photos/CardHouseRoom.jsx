...
import { Edit2, Trash2, Users, Bath, Square, Home, Star, Eye, Bed } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="relative ">
        ...
        {/* Admin Actions */}
        <div className="absolute top-4 right-4 flex space-x-2 opacity-100  transition-opacity">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onEdit(room, true);
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 mb-6">
          ...
          {room?.beds && room?.beds?.length > 0 && (
            <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
              <Bed size={20} className="text-blue-600 mb-1" />
